...
from Desktop_Application.Frontend.ui_utils import setup_phone_input


class FirstTimeSetupDialog(QDialog):
    def __init__(self, user_data, parent=None):
        super().__init__(parent)
        uic.loadUi(resource_path("ui-files/firstTime-setup.ui"), self)
    ...
    def setup_password_toggle(self, line_edit, tool_button, icon_show=resource_path("Icons/eye.png"), icon_hide=resource_path("Icons/hide.png")):
