...
class AddServicePopUp(QWidget):
    def __init__(self, parent=None, main_window=None):
        ...
        uic.loadUi(resource_path("ui-files/addService.ui"), self)
    ...
    def create_service_cards(self, service_types):
        ...
        for service_type in service_types:
            try:
                ...
                # Load the card UI
                card_ui = uic.loadUi(resource_path("ui-files/ServiceTypeCard.ui"))
    ...
    def create_pagination_controls(self, search_term=None):
        ...
        try:
            ...
            self.service_pagination_widget = uic.loadUi(resource_path("ui-files/paginationUi.ui"))
        ...
        def _on_success(service_type):
            ...
            if self.main_window:
                Toast(self.main_window, f"Editing '{service_type.get('name')}'",
                      icon_path=resource_path("Icons/info.png")).show_toast()
    ...
    def handle_add_edit_service(self):
        ...
        if not name:
            Toast(self.main_window, "Service name is required", icon_path=resource_path("Icons/warning.png")).show_toast()
            return
        ...
        if self.is_edit_mode and self.selected_service_type_id:
            ...
            def _on_success(_data):
                Toast(self.main_window, "Service updated!", icon_path=resource_path("Icons/check.png")).show_toast()
                self.reset_add_form()
            ...
            def _on_error(msg: str):
                Toast(self.main_window, f"Failed to update service: {msg}", icon_path=resource_path("Icons/warning.png")).show_toast()
        ...
        def _on_success(_data):
            Toast(self.main_window, "Service added!", icon_path=resource_path("Icons/check.png")).show_toast()
            self.reset_add_form()
            self.load_service_types(1, show_loading=False)
            if hasattr(self.main_window, 'addAppointmentCard'):
                self.main_window.addAppointmentCard.load_service_types_to_combobox()
        ...
        def _on_error(msg: str):
            Toast(self.main_window, f"Failed to add service: {msg}", icon_path=resource_path("Icons/warning.png")).show_toast()
    ...
    def create_service_type(self, service_data):
        ...
        def _on_success(_data):
            ...
            Toast(self.main_window, "Service type created successfully!", icon_path=resource_path("Icons/check.png")).show_toast()

        def _on_error(msg: str):
            Toast(self.main_window, f"Failed to create service type: {msg}", icon_path=resource_path("Icons/warning.png")).show_toast()
    ...
    def update_service_type(self, service_data):
        ...
        def _on_success(_data):
            self.reset_form()
            self.load_service_types(self.service_currentPage, show_loading=False)
            Toast(self.main_window, "Service type updated successfully!", icon_path=resource_path("Icons/check.png")).show_toast()

        def _on_error(msg: str):
            Toast(self.main_window, f"Failed to update service type: {msg}", icon_path=resource_path("Icons/warning.png")).show_toast()
