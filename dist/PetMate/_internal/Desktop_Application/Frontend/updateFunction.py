...
class Update:
    ...
    def update_patient_info(self, owner_id):
        self.api.get(
            ...
            on_error=lambda err: Toast(self.ui, "Failed to load patient!", icon_path=resource_path("Icons/warning.png")).show_toast(),
            timeout=15,
            show_loading=True,
    ...
    def _on_patient_loaded_for_edit(self, patient):
        try:
            ...
            Toast(self.ui, "Failed to load patient!", icon_path=resource_path("Icons/warning.png")).show_toast()
    ...
    def is_email_enable(self,owner_id):
        ...
        self.api.get(
            ...
            on_error=lambda err: Toast(self.ui, "Failed to check patient email!", icon_path=resource_path("Icons/warning.png")).show_toast(),
            timeout=10
        )
    def update_patient_to_api(self):
        patient_id = getattr(self.ui, "selected_patient_id", None)
        if not patient_id:
            Toast(self.ui, "No patient selected!", icon_path=resource_path("Icons/warning.png")).show_toast()
            return
        ...
        if not formatted_phone:
            Toast(self.ui, "Invalid phone number. Use 09xxxxxxxxx or +639xxxxxxxxx", icon_path=resource_path("Icons/warning.png")).show_toast()
            return
        ...
        if raw_secondary:
            ...
            if not formatted_secondary:
                Toast(self.ui, "Invalid secondary phone number.", icon_path=resource_path("Icons/warning.png")).show_toast()
                return
        else:
        ...
        for combo, name in [
            ...
            if combo.currentIndex() == 0 or combo.currentText().strip() == "":
                Toast(self.ui, f"Invalid {name} selected!", icon_path=resource_path("Icons/warning.png")).show_toast()
                return
        ...
        def compare_and_update(current_patient):
            ...
            if current == new:
                def post_no_update_ui():
                    self.ui.clearInputs()
                    self.ui.navigate_to_page(2)
                    self.ui.load_patients(getattr(self.ui, 'patient_currentPage', None) or 1, search_term=None)
                    Toast(self.ui, "No updates made.", icon_path=resource_path("Icons/check.png")).show_toast()
                QTimer.singleShot(100, post_no_update_ui)
                return
            ...
            self.api.post(
                ...
                on_error=lambda err: Toast(self.ui, f"Unexpected error: {str(err)}", icon_path=resource_path("Icons/warning.png")).show_toast(),
                timeout=15,
                show_loading=True,
        ...
        self.api.get(
            ...
            on_error=lambda err: Toast(self.ui, "Failed to check for changes!", icon_path=resource_path("Icons/warning.png")).show_toast(),
            timeout=10,
            show_loading=True,
    ...
    def _on_patient_duplicate_checked(self, patient_id, data, dup_response):
        try:
            ...
            self.api.put(
                ...
                on_error=lambda err: Toast(self.ui, "Update failed!", icon_path=resource_path("Icons/warning.png")).show_toast(),
                timeout=20,
                show_loading=True,
                loading_title="Updating patient...",
            ...
            Toast(self.ui, f"Unexpected error: {str(e)}", icon_path=resource_path("Icons/warning.png")).show_toast()
    ...
    def _on_patient_updated(self, patient_id, data):
        ...
        def post_update_ui():
            ...
            Toast(self.ui, "Patient updated successfully!", icon_path=resource_path("Icons/check.png")).show_toast()
    ...
    def update_pet_info(self, pet_id):
        self.api.get(
            ...
            on_error=lambda err: Toast(self.ui, "Failed to load pet!", icon_path=resource_path("Icons/warning.png")).show_toast(),
            timeout=15,
            show_loading=True,
    ...
    def _on_pet_loaded_for_edit(self, pet):
        try:
            ...
            Toast(self.ui, "Failed to load pet!", icon_path=resource_path("Icons/warning.png")).show_toast()
    ...
    def update_pet_to_api(self):
        ...
        def compare_and_update(current_pet):
            ...
            new = {
                ...
                "sex": norm(data["sex"]),
                "owner_id": str(data["owner_id"] or ""),
                "remarks": norm(data["remarks"]),
                "birthDay": norm(data.get("birthDay")),
                "stored_age": norm(data.get("stored_age"))
            }
            if current == new:
            ...
            self.api.put(
                ...
                on_error=lambda err: Toast(self.ui, "Failed to update pet!", icon_path=resource_path("Icons/warning.png")).show_toast(),
                timeout=20,
                show_loading=True,
    ...
    def _on_pet_updated(self, pet_id, pet_url):
        Toast(self.ui, "Pet updated successfully!", icon_path=resource_path("Icons/check.png")).show_toast()
    ...
    def update_service_info(self, service_id):
        ...
        self.api.get(
            ...
            on_error=lambda err: Toast(self.ui, "Failed to load service!", icon_path=resource_path("Icons/warning.png")).show_toast(),
            timeout=15,
            show_loading=True,
    ...
    def _on_service_loaded_for_edit(self, service):
        try:
            ...
            Toast(self.ui, "Failed to load service!", icon_path=resource_path("Icons/warning.png")).show_toast()

    def update_service_to_api(self):
        service_id = self.ui.selected_service_id  # Make sure this is set when clicking "edit"
        if not service_id:
            Toast(self.ui, "No service selected for update!", icon_path=resource_path("Icons/warning.png")).show_toast()
            return
        ...
        def compare_and_update(current_service):
            def norm(val):
                ...
                return str(val).strip() if val is not None else ""
            current = {
                "owner": str(current_service.get("owner") or ""),
                "pet": str(current_service.get("pet") or ""),
                "service_type_id": str(current_service.get("service_type_id") or ""),
            ...
            new = {
                "owner": str(data["owner"] or ""),
                "pet": str(data["pet"] or ""),
                "service_type_id": str(data["service_type_id"] or ""),
                "date": norm(data["date"]),
            ...
            if current == new:
                self.ui.service_stackedWidget(0)
            ...
            self.api.put(
                ...
                on_error=lambda err: Toast(self.ui, "Failed to update service!", icon_path=resource_path("Icons/warning.png")).show_toast(),
                timeout=20,
                show_loading=True,
    ...
    def _on_service_updated(self, service_id):
        Toast(self.ui, "Service updated successfully!", icon_path=resource_path("Icons/check.png")).show_toast()
    ...
    def update_service_type_info(self, service_type_id):
        ...
        self.api.get(
            ...
            on_error=lambda err: Toast(self.ui, "Failed to load service type", icon_path=resource_path("Icons/warning.png")).show_toast(),
            timeout=15,
            show_loading=True,
    ...
    def update_service_type_to_api(self, service_type_id):
        ...
        def compare_and_update(current_type):
            ...
            self.api.put(
                url=url,
                data=data,
                on_success=lambda _: Toast(self.ui, "Service type updated successfully!", icon_path=resource_path("Icons/check.png")).show_toast(),
                on_error=lambda err: Toast(self.ui, "Failed to update service type!", icon_path=resource_path("Icons/warning.png")).show_toast(),
                timeout=20,
                show_loading=True,
