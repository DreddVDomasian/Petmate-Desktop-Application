...
class AddAppointmentCard(QWidget):
    def __init__(self, parent=None, main_window=None):
        ...
        uic.loadUi(resource_path("ui-files/addAppointmentCard.ui"), self)
    ...
    def submit_appointment_data(self):
        ...
        if missing:
            ...
            toast = Toast(self.main_window, message, icon_path=resource_path("Icons/warning.png"))
            toast.show_toast()
            return
            ...
            if not slot_details.get('available', True):
                ...
                if slot_details.get('is_past', False):
                    toast = Toast(self.main_window, "This time slot has already passed! Please choose a future time.",
                                  icon_path=resource_path("Icons/warning.png"))
                else:
    ...
    def _on_appointment_added(self, response):
        ...
        toast = Toast(self.main_window, "Appointment added!", icon_path=resource_path("Icons/check.png"))
        toast.show_toast()
    ...
    def _on_appointment_error(self, error_msg):
        ...
        toast = Toast(self.main_window, "Failed to add appointment!", icon_path=resource_path("Icons/warning.png"))
        toast.show_toast()
    ...
    def cancelled_appointment(self, appointment_id):
        ...
        def clicked_yes():
            ...
            def _on_cancel_failed(err):
                ...
                toast = Toast(self.main_window, "Failed to cancel appointment!", icon_path=resource_path("Icons/warning.png"))
                toast.show_toast()
    ...
    def show_toast(self, message, type="info"):
        ...
        icon_map = {
            "success": resource_path("Icons/check.png"),
            "warning": resource_path("Icons/warning.png"),
            "error": resource_path("Icons/error.png"),
            "info": resource_path("Icons/info.png")
        }

        toast = Toast(self.main_window, message, icon_path=resource_path(icon_map.get(type, "Icons/info.png")))
        toast.show_toast()
    ...
    def add_web_pagination_controls(self, layout, current_page, total_pages, request_filter):
        ...
        # Load pagination UI
        self.web_pagination_widget = uic.loadUi(resource_path("ui-files/paginationUi.ui"))
    ...
    def create_walkin_card(self, appoint):
        ...
        try:
            card = uic.loadUi(resource_path("ui-files/webAppointmentCard.ui"))
    ...
    def show_review_page(self, appoint, date):
        ...
        self.main_window.ReviewPetIcon.setPixmap(QPixmap(resource_path(icon_path) if not os.path.isabs(icon_path) else icon_path))
    ...
    def _on_accepted_saved(self, walkin_id, owner_id):
        ...
        toast = Toast(self.main_window, "Appointment accepted successfully!", icon_path=resource_path("Icons/check.png"))
        toast.show_toast()
    ...
    def _on_accept_failed(self, err):
        ...
        toast = Toast(self.main_window, "Failed to accept appointment!", icon_path=resource_path("Icons/warning.png"))
        toast.show_toast()
        self._set_review_action_busy(False)
    ...
    def _on_decline_failed(self, err):
        ...
        toast = Toast(self.main_window, "Failed to decline appointment!", icon_path=resource_path("Icons/warning.png"))
        toast.show_toast()
        self._set_review_action_busy(False)
...
class AppointmentCardManager:
    ...
    def create_appointment_card(self, appointment):
        ...
        card = uic.loadUi(resource_path("ui-files/appointmentCard.ui"))
    ...
    def add_appointment_pagination_controls(self, layout, status_filter=None, search_term=None):
        ...
        try:
            self.appointment_pagination_widget = uic.loadUi(resource_path("ui-files/paginationUi.ui"))
...
class ScheduledServiceCardManager:
    ...
    def create_scheduled_card(self, service):
        ...
        try:
            card = uic.loadUi(resource_path("ui-files/schedCard.ui"))
    ...
    def show_toast(self, message, type="info"):
        ...
        toast = Toast(self.main_window, message, icon_path=icon_map.get(type, resource_path("Icons/info.png")))
        toast.show_toast()
