...
from Desktop_Application.Frontend.shadowEffects import create_card_shadow
from Desktop_Application.Frontend.api_client import desktop_login, send_otp, verify_otp_and_reset_password
from Desktop_Application.Frontend.api_worker import APIWorker
import requests
...
class LoginDialog(QDialog):
    def __init__(self, parent=None):
        ...
        uic.loadUi(resource_path("ui-files/LoginCard.ui"), self)
    ...
    def send_otp_request(self):
        ...
        if not email:
            toast = Toast(parent=self, message="Please enter your email address", icon_path=resource_path("Icons/warning.png"),duration=2000)
            toast.show_toast()
            return
    ...
    def on_otp_sent(self, success, response):
        ...
        if success:
            ...
            toast = Toast(parent=self, message="OTP sent successfully! Check your email.", icon_path=resource_path("Icons/check.png"),duration=2000)
            toast.show_toast()
            self.sendOtpBtn.setText("Send OTP")
            self.sendOtpBtn.setEnabled(True)
        else:
            toast = Toast(parent=self, message="Failed to send OTP.", icon_path=resource_path("Icons/warning.png"),duration=2000)
            toast.show_toast()
            self.sendOtpBtn.setText("Send OTP")
            self.sendOtpBtn.setEnabled(True)
    ...
    def verify_otp(self):
        ...
        if not otp:
            toast = Toast(parent=self, message="Please enter the OTP.", icon_path=resource_path("Icons/warning.png"), duration=2000)
            toast.show_toast()
            return

        if not self.otp_email:
            toast = Toast(parent=self, message="Email not found. Please restart the process.",
                          icon_path=resource_path("Icons/warning.png"), duration=2000)
            toast.show_toast()
            return
        ...
        try:
            ...
            if success:
                ...
                self.otp_code = otp
                toast = Toast(parent=self, message="OTP verified successfully!", icon_path=resource_path("Icons/check.png"),
                              duration=2000)
                toast.show_toast()
                ...
                toast = Toast(parent=self, message=error_msg, icon_path=resource_path("Icons/warning.png"), duration=2000)
                toast.show_toast()
            ...
            toast = Toast(parent=self, message="Error verifying OTP", icon_path=resource_path("Icons/warning.png"), duration=2000)
            toast.show_toast()
            self.proceedBtn.setText("Proceed")
            self.proceedBtn.setEnabled(True)
    ...
    def reset_password(self):
        ...
        if not all([new_password, confirm_password]):
            toast = Toast(parent=self, message="Please fill all fields", icon_path=resource_path("Icons/warning.png"), duration=2000)
            toast.show_toast()
            return

        if new_password != confirm_password:
            toast = Toast(parent=self, message="Passwords do not match", icon_path=resource_path("Icons/warning.png"), duration=2000)
            toast.show_toast()
            return
        ...
        try:
            ...
            if success:
                toast = Toast(parent=self, message="Password reset successfully!", icon_path=resource_path("Icons/check.png"),
                              duration=2000)
                toast.show_toast()
            ...
            toast = Toast(parent=self, message="Error resetting password", icon_path=resource_path("Icons/warning.png"), duration=2000)
            toast.show_toast()
            self.submitNewPass.setText("Reset Password")
            self.submitNewPass.setEnabled(True)
    ...
    def attempt_login(self):
        ...
        if not username or not password:
            toast = Toast(parent=self, message="Please enter both username and password", icon_path=resource_path("Icons/warning.png"), duration=2000)
            toast.show_toast()
            return
    ...
    def on_login_finished(self, success, response):
        ...
        if success:
            ...
            toast = Toast(parent=self, message="Username or password not found", icon_path=resource_path("Icons/warning.png"), duration=2000)
            toast.show_toast()
