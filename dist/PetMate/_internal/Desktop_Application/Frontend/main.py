...
def load_fonts():
    ...
    try:
        font_path = resource_path("font/Montserrat/Montserrat-VariableFont_wght.ttf")
...
def main():
    ...
    try:
        ...
        from Desktop_Application.Frontend.login_dialog import LoginDialog
        from Desktop_Application.Frontend.first_time_setup_dialog import FirstTimeSetupDialog
        from Desktop_Application.Frontend.app import MainUI
